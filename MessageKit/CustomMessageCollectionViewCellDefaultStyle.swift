...
public class CustomMessageCollectionViewCellDefaultStyle: CustomMessageCollectionViewCellStyleProtocol {
    ...
    lazy var images: [String: UIImage] = {
        return [
            "incoming_tail" : UIImage(named: "bubble-incoming-tail", inBundle: NSBundle(forClass: CustomMessageCollectionViewCellDefaultStyle.self), compatibleWithTraitCollection: nil)!,
            "incoming_notail" : UIImage(named: "bubble-incoming", inBundle: NSBundle(forClass: CustomMessageCollectionViewCellDefaultStyle.self), compatibleWithTraitCollection: nil)!,
            "outgoing_tail" : UIImage(named: "bubble-outgoing-tail", inBundle: NSBundle(forClass: CustomMessageCollectionViewCellDefaultStyle.self), compatibleWithTraitCollection: nil)!,
            "outgoing_notail" : UIImage(named: "bubble-outgoing", inBundle: NSBundle(forClass: CustomMessageCollectionViewCellDefaultStyle.self), compatibleWithTraitCollection: nil)!,
        ]
    }()
    
    lazy var folderCoverImage: UIImage = {
        return UIImage(named: "folder-cover", inBundle: NSBundle(forClass: CustomMessageCollectionViewCellDefaultStyle.self), compatibleWithTraitCollection: nil)!
    }()
    ...
    public func folderImage(viewModel viewModel: CustomMessageViewModelProtocol, isSelected: Bool) -> UIImage {
        return folderCoverImage
    }
    
    public func bubbleImage(viewModel viewModel: CustomMessageViewModelProtocol, isSelected: Bool) -> UIImage {
    ...
    public func bubbleImageBorder(viewModel viewModel: CustomMessageViewModelProtocol, isSelected: Bool) -> UIImage? {
        return self.baseStyle.borderImage(viewModel: viewModel)
    }
    
    public func titleFont(viewModel viewModel: CustomMessageViewModelProtocol, isSelected: Bool) -> UIFont {
        return titleFont
    }
    public func titleColor(viewModel viewModel: CustomMessageViewModelProtocol, isSelected: Bool) -> UIColor {
        return UIColor.blackColor()
    }
    public func textFont(viewModel viewModel: CustomMessageViewModelProtocol, isSelected: Bool) -> UIFont {
        return textFont
    }
    public func textColor(viewModel viewModel: CustomMessageViewModelProtocol, isSelected: Bool) -> UIColor {
